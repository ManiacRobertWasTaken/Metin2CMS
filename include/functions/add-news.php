<?php
		...
		print '<p><a class="btn btn-primary" data-bs-toggle="collapse" href="#add" aria-expanded="false" aria-controls="add"><i class="fa fa-plus fa-2" aria-hidden="true"></i> '.$lang['new-article'].'</a></p>';
		print '<div class="collapse" id="add"><div class="card card-body">';
