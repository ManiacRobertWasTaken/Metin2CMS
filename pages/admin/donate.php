	...
	<table class="table table-hover">
		...
		<?php $i=1; foreach($jsondataDonate as $key => $donate) { ?>
			<tr>
				...
				<td><?php print e($donate['name']); ?></td>
				<td><form action="" method="post" style="display:inline"><?php echo csrfField(); ?><input type="hidden" name="del" value="<?php print intval($key); ?>"><button type="submit" name="submit_delete_method" class="btn btn-primary btn-sm"><?php print $lang['delete']; ?></button></form></td>
			</tr>
		<?php } ?>
		</tbody>
	</table>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<select class="form-control" name="currency">
									...
									?>
									<option value="<?php print $key; ?>"><?php print e($currency['name']); ?></option>
									<?php } ?>
								</select>
							</div>
							<div class="col-sm-4">
