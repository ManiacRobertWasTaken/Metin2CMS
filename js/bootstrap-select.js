          ...
          drop =
            '<div class="btn-group bootstrap-select' + multiple + inputGroup + '">' +
              ...
              '<div class="dropdown-menu open">' +
                ...
                searchbox +
                actionsbox +
                '<ul class="dropdown-menu inner" style="padding: 5px;" role="menu"></ul>' +
                donebutton +
              '</div>' +
            '</div>';
    ...
    createLi: function() {
      ...
      var generateLI = function(content, index, classes, optgroup) {
        return '<li' +
            ...
            ((typeof index!=='undefined' & index!==null) ? ' style="border-bottom: 1px solid #eee;" data-original-index="' + index + '"' : '') +
